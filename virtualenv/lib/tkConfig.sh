...
TK_LIBS='-L/usr/X11R6/lib -lX11 -Wl,-weak-lXss -lXext   -framework CoreFoundation   -framework CoreFoundation '

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/Users/Niels/git/summit/virtualenv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/Niels/git/summit/virtualenv'
...
# build directory.
TK_BUILD_LIB_SPEC='-L-------src-dir--------/tk8.5.13/unix -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/Niels/git/summit/virtualenv/lib -ltk8.5'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/Niels/git/summit/virtualenv/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L-------src-dir--------/tk8.5.13/unix -ltkstub8.5'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/Niels/git/summit/virtualenv/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='-------src-dir--------/tk8.5.13/unix/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Users/Niels/git/summit/virtualenv/lib/libtkstub8.5.a'
